...
class MobileLocationCard extends Component {
    state = { star: false };
        ...
        return (
            <>
                <Card className={hoverCard} elevation={4}>
                    ...
                    <CardActionArea
                        onClick={() =>
                            this.props.toggleLocDrawer(this.props.location)
                        }
                    ...
                    >
                        ...
                        <h3 className='mobile-card-tripname'>
                    ...
                    <CardActions
                        className={
                            'cardButtons' + this.props.location.locationTypeId
                        }
                    >
                        <p className='price'>
                            <b>
                        ...
                        <Button
                            ...
                            // onClick={() => this.toggleDrawer(this.props.location)}
                            onClick={() =>
                                this.props.clickedCardItem(this.props.location)
                            }
                        >
                            Fly to
                        </Button>
